...
public class TC_FailedPayment {
	 ...
	 * In this case- Failed credit payment scenario 
	 */
	public void loadJsonData()
	{
		userdetails=st.loadJsonData("UserInfoPayFailure.json");
	}
	 @Test(priority=1)
	  ...
	  {
		  result=false;
		  result=pm.verifyPurchaseFailure();
		  Assert.assertEquals(result, true, "Failed payment message didnt get displayed");
	  }
	}
